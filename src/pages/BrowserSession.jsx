...
function ResultPanel({ result }) {
  ...
  return (
    <div className="bg-card border border-border p-4 space-y-3">
      ...
      {screenshot && (
        <div className="bg-secondary/30 border border-border px-3 py-2">
          <div className="text-muted-foreground/40 uppercase tracking-wider mb-1.5 text-[9px]">Screenshot Preview</div>
          {screenshot.startsWith('data:') || screenshot.startsWith('http') ? (
            <img src={screenshot} alt="Screenshot" className="w-full rounded border border-border/50 max-h-80 object-contain" />
          ) : (
