...
import { Home, Radio, Eye, Terminal, Layers, Shield, Wrench, FileText } from 'lucide-react';
    ...
    <div className="h-screen w-screen flex flex-col overflow-hidden bg-background font-mono">
      ...
      <div className="shrink-0 border-b border-border bg-card px-6 py-3 flex items-center gap-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <div>
            <h1 className="text-[13px] font-bold text-foreground tracking-wide">AI Operator Control Room</h1>
            <p className="text-[9px] text-slate-400">Veridan Core · Governed Preview Mode · OpenClaw Gateway</p>
          </div>
        </div>
        <div className="ml-auto flex items-center gap-2">
          <Link
            to="/openclaw-control"
            className="px-3 py-1.5 text-[10px] border border-border text-slate-400 hover:bg-secondary/50 transition-colors rounded font-semibold"
          >
            OpenClaw Full Panel →
          </Link>
        </div>
