  ...
  return (
    <div className="space-y-4">
      ...
      <div>
        ...
        <div className="text-[9px] text-slate-500 mt-0.5">Plain English view of phases 26–52 and future gates. How it all connects.</div>
      </div>
      ...
      <div className="flex items-center gap-2 px-4 py-3 bg-primary/10 border border-primary/20 rounded-lg">
        ...
        <div>
          ...
          <div className="text-[10px] text-primary mt-0.5">Phase 52 Complete — OpenClaw Status / Version / Capabilities Contract Installed</div>
        </div>
      </div>
