/**
 * ProposedActionsPanel — Planning-only proposed actions placeholder.
 * No AI runtime calls. No OpenClaw dispatch. No external API mutation. localStorage-only future expansion.
 */
  ...
  return (
    <div className="space-y-4 font-mono">
      ...
      <div>
        ...
        <div className="text-[8px] text-slate-500 mt-0.5">Planning-only action collection · No OpenClaw dispatch</div>
      </div>
      ...
      <div className="bg-card border border-border/50 rounded-sm p-6">
        <div className="text-center py-8 text-slate-500">
          <div className="text-[9px] font-bold uppercase mb-2">Proposed Actions Panel</div>
          <div className="text-[8px] text-slate-500 max-w-md mx-auto leading-relaxed">
            This panel is a planning-only placeholder for organizing proposed actions and operator recommendations.
            Future expansion: localStorage-only action collection and export (no OpenClaw dispatch integration).
          </div>
        </div>
      </div>
      ...
      <div className="px-3 py-2.5 bg-primary/5 border border-primary/15 rounded-sm">
        ...
        <div className="flex flex-wrap gap-1">
          {[
            'Proposed actions planning only',
            'No AI runtime calls',
            'No Codex execution',
