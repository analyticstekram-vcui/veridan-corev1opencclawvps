/**
 * BusinessEntityRegistry — Planning-only entity registry placeholder.
  ...
  return (
    <div className="space-y-4 font-mono">
      <div>
        ...
        <div className="text-[8px] text-slate-500 mt-0.5">Plan entity structures · No legal filing · No API calls · No credential storage</div>
      </div>
      ...
      <div className="px-4 py-6 bg-card border border-border/40 rounded-sm text-center">
        <div className="text-[9px] font-bold text-slate-400 mb-1">Entity Registry — Coming Soon</div>
        <div className="text-[8px] text-slate-600">
          Future: Track planned business entities, formation status, state of registration, and entity type — all localStorage-only.
        </div>
      </div>
